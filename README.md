...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/angelokapunda/conta_bancaria.git) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/angelokapunda/conta_bancaria.git
```
...
Desenvolvido por [**Angelo dos Santos**](https://github.com/angelokapunda)
